...
import { assembleGen3BlockBulkRead } from 'fractal-midi/gen3/axe-fx-iii';
...
console.log('fractal-gen3 sim golden (M0, offline)');
...
console.log(`\nfractal-gen3 sim golden: ${passed} passed, ${failed} failed`);
