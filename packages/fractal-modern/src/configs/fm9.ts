 ...
 * DEVICE-TRUE param catalog (`fractal-midi/fm9`) mined from FM9-Edit's own
 ...
 */
import { FM9_PARAMS_BY_FAMILY, FM9_ENUM_OVERRIDES } from 'fractal-midi/fm9';
...
export const FM9_CONFIG: FractalModernConfig = {
  ...
  // preset above 127 lands in bank 0. III/FM3 keep the spec-standard CC0<<7|CC32.
  bank_select: 'msb',
