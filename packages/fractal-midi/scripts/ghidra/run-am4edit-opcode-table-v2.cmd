@echo off
REM Mine AM4-Edit.exe (64-bit) opcode table via the 64-bit-aware,
REM multi-prefix DumpFractalEditorOpcodeTable64.java.
REM
REM Output: samples\captured\decoded\ghidra-am4-edit-opcode-map-v2.txt
...
echo Done. Output: %OUT_DIR%\ghidra-am4-edit-opcode-map-v2.txt
endlocal
