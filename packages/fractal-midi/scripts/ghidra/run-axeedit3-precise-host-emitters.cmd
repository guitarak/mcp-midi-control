@echo off
REM Headless run of PreciseAxeEditIIIHostEmitters.java.
REM Output:
REM   %PROJECT_ROOT%\packages\fractal-midi\samples\captured\decoded\ghidra-axe-edit-iii-host-emitters-precise.txt
...
"%HEADLESS%" "%PROJECT_DIR%" "%PROJECT_NAME%" ^
    ...
    -postScript PreciseAxeEditIIIHostEmitters.java
