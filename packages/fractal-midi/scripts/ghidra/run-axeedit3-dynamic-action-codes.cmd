@echo off
REM Headless run of DecodeAxeEditIIIDynamicActionCodes.java.
REM Output:
REM   %PROJECT_ROOT%\packages\fractal-midi\samples\captured\decoded\ghidra-axe-edit-iii-dynamic-action-codes-decode.txt
...
"%HEADLESS%" "%PROJECT_DIR%" "%PROJECT_NAME%" ^
    ...
    -postScript DecodeAxeEditIIIDynamicActionCodes.java
