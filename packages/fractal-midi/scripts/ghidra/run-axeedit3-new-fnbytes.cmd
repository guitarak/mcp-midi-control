@echo off
REM Headless run of DecodeAxeEditIIINewFnBytes.java.
REM Output:
REM   %PROJECT_ROOT%\packages\fractal-midi\samples\captured\decoded\ghidra-axe-edit-iii-new-fnbytes-decode.txt
...
"%HEADLESS%" "%PROJECT_DIR%" "%PROJECT_NAME%" ^
    ...
    -postScript DecodeAxeEditIIINewFnBytes.java
