@echo off
REM Headless run of FindAxeEditIIBlockAllocator.java against Axe-Edit.exe
REM (II generation, 32-bit). BK-070 Session 116 â€” hunting the blockâ†’chunk
REM allocator function that handles layout-dependent paramBase.
REM
REM Output:
REM   %PROJECT_ROOT%\packages\fractal-midi\samples\captured\decoded\ghidra-axe-edit-block-allocator.txt
...
"%HEADLESS%" "%PROJECT_DIR%" "%PROJECT_NAME%" ^
    ...
    -postScript FindAxeEditIIBlockAllocator.java
