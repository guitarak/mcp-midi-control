// DumpAxeEditIIIParamTablesV2.java â€” Ghidra GhidraScript
//
// V2 revision based on what V1 revealed:
//
//   The DAT_xxx tables aren't `-1`-terminated int arrays â€” they're
...
//   (with a 175/176/177 cluster) â€” that's the entire param list for
...
public class DumpAxeEditIIIParamTablesV2 extends GhidraScript {
    ...
    // (caseIdx, virtualAddress) â€” same as V1.
    ...
    public void run() throws Exception {
        ...
        w("================================================================================");
        w("Axe-Edit III RE â€” DumpAxeEditIIIParamTablesV2.java");
        ...
        for (long[] pair : CASE_TO_DAT) {
            ...
            if (!metadataPtrs.isEmpty()) {
                ...
                if (firstPtr >= 0x140000000L && firstPtr < 0x150000000L) {
                    ...
                    w("    (ptr out of image range â€” likely not a pointer)");
                }
            }
        }
