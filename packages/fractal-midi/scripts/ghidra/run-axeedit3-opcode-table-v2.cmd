@echo off
REM Mine "Axe-Edit III.exe" (64-bit) opcode table via the 64-bit-aware,
REM multi-prefix DumpFractalEditorOpcodeTable64.java.
REM
REM Output: samples\captured\decoded\ghidra-axe-edit-iii-opcode-map-v2.txt
...
echo Done. Output: %OUT_DIR%\ghidra-axe-edit-iii-opcode-map-v2.txt
endlocal
